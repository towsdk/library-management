          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="statistic-block block">
                <div class="progress-details d-flex align-items-end justify-content-between">
                  ...
                  <div class="number dashtext-2">{{$books}}</div>
                </div>
                <div class="progress progress-template">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="statistic-block block">
                <div class="progress-details d-flex align-items-end justify-content-between">
                  ...
                  <div class="number dashtext-3">{{$borrows}}</div>
                </div>
                <div class="progress progress-template">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="statistic-block block">
                <div class="progress-details d-flex align-items-end justify-content-between">
                  <div class="title">
                    <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Returned</strong>
                  </div>
